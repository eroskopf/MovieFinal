...
full = full.drop("Film_x", axis = 1)
full = full.drop("Movie Genre", axis = 1)
full = full.drop("IMDB Rating", axis = 1)
full = full.drop("Year of Release", axis = 1)
full = full.drop("Movie Time", axis = 1)
full = full.drop("Film ID", axis = 1)
print(full.head())
